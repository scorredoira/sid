...
impl MappableCommand {
    ...
    static_commands!(
        ...
        hunk_stage, "Stage the hunk under the cursor of the uncommitted diff on screen",
        hunk_unstage, "Unstage the hunk under the cursor of the uncommitted diff on screen",
        hunk_discard, "Discard the hunk under the cursor of the uncommitted diff on screen, after asking",
